  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        {/* FLOATING ANIMATED NAME BANNER */}
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black font-orbitron tracking-tight text-white mb-6 leading-none uppercase select-none">
          {nameText.split("").map((char, index) => (
            <span
              key={index}
              className={`animate-float-letter ${char === " " ? "mr-4" : ""} text-white hover:text-[#00F0FF] transition-colors duration-300`}
